...
public class UserSubscriptionRepository : IUserSubscriptionRepository
{
    ...
    public async Task<UserSubscription?> GetByIdAsync(string id)
    {
        ...
        const string sql = @"
            SELECT subscription_id as Id, user_id as UserId, plan_id as SubscriptionPlanId, 
    ...
    public async Task<UserSubscription> CreateAsync(UserSubscription subscription)
    {
        ...
        const string sql = @"
            ...
            VALUES (@Id, @UserId, @SubscriptionPlanId, @StartDate, @EndDate, 
    ...
    public async Task<bool> UpdateAsync(UserSubscription subscription)
    {
        ...
        const string sql = @"
            ...
            SET plan_id = @SubscriptionPlanId,
                end_date = @EndDate,
    ...
    {
        using var connection = _connectionFactory.CreateConnection();
        const string sql = "UPDATE user_subscriptions SET status = 'canceled' WHERE subscription_id = @Id";
